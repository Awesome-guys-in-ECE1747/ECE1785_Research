...
\end{itemize}
%计划要做哪些任务
For the emotion status, we classify the emotional factor into 6 categories, adapted from Parrot's theory: love, joy, surprise, fear, sadness and anger. %outcome
\\\\
...
\\\\
For the data processing, % collect and analyze
