...
There are two research questions we conduct about emotion formation and effect which we will figure out through the research.
\begin{itemize}
...
In this section, we introduce the two studies we conduct based on quantitative and qualitative methods respectively.
...
In this section, we will talk about our plans for emotion predictions. We plan to use text emotion mining for this part. We will take the commit messages and their description as raw data for us to do the data mining. And there are several phases in our plan, shown below. 
\begin{itemize}
...
\par
For the data processing, we plan to record interviews by scripts and analyze the interview by open coding and selective coding. As our questions are designed for different section of our research questions respectively, we could divide the script into several sections and evaluate them separately.
...
happy    & 611.52  & 311.61    & 299.91    \\ 
love     & 590.75  & 483.69    & 107.06    \\ 
surprise & 1473.96 & 25.05     & 1448.91   \\ 
sad      & 714.88  & 593.83    & 121.05    \\ 
anger    & 332.011 & 174.36    & 157.65    \\ 
fear     & 365.89  & 163.32    & 202.57    \\ 
\Xhline{2\arrayrulewidth}
\end{tabular}
\label{tb.q}
\end{table}
...
The interviewees are categorized by their employment status. Typically, we should divide them by different dimensions, however, in this study, we didn't get enough participants for a more trustful conclusion. Thus, in all other ways of division, we may have only one participant in the particular division. For example, there's only one participant who have experience on UX/UI design and one majored in database architecture. Ideally, we consider a complete investigation should invite 50 participants from different sources and networks in order to cover all the position in software development with all individual bias.
